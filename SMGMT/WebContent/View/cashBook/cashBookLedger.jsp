...
<%@page import="com.servletStore.cashBook.Ledger.model.CashBookLedgAccPOJO"%>
<%@page import="com.servletStore.cashBook.Ledger.model.CashBookLedgAccIMPL"%>
<%@page import="com.servletStore.cashBook.Ledger.model.CashBookLedgAccDAO"%>
<%@page import="com.servletStore.cashBook.addCashBook.model.AddCashBookPOJO"%>
<%@page import="com.servletStore.cashBook.addCashBook.model.AddCashBookIMPL"%>
<%@page import="com.servletStore.cashBook.addCashBook.model.AddCashBookDAO"%>
		...
		<div class="wrapper">
			...
			<div id="content" class="bg-container">
					...
					<div class="row no-gutters">
						<div class="col-sm-5 col-lg-6">
							<h4 class="nav_top_align">
								<i class="fa fa-pencil"></i> CashBook Ledger/Account
							</h4>
						</div>
						<div class="col-sm-7 col-lg-6">
							<ol class="breadcrumb float-right nav_breadcrumb_top_align">
								...
								<li class="active breadcrumb-item">CashBook Ledger/Account </li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-file-text-o"></i>CashBook Ledger/Account
									</div>
									<div class="card-block m-t-35">
										<form action="/SMGMT/CashBookLedgerAccount" method="post"	class="form-horizontal  login_validator" id="form_block_validator">
											...
											<div class="form-group row">
	                                           ...
	                                           List<CashBookLedgAccPOJO> list1=dao.selectCashBook();
	                                           Iterator<CashBookLedgAccPOJO> itr=list1.iterator();
	                                           %>
	                                              <select class="form-control chzn-select" tabindex="2" name="selectCashBook" id="required2" required>
	                                            	 <option disabled selected>select CashBook</option>
	                                              	...
	                                              	while(itr.hasNext())
	                                              	{
	                                              		CashBookLedgAccPOJO pojo=(CashBookLedgAccPOJO)itr.next();
	                                              		int id=((CashBookLedgAccPOJO)pojo).getCashBookId();
	                                              		String cashBook=((CashBookLedgAccPOJO)pojo).getCashBookName();
	                                              	
	                                              	%>
	                                                 <option value="<%=id%>"><%=cashBook %></option>
	                                                  <%
	                                              	}
	                                                  %>
	                                              </select>
											...
											<div class="form-group row">
												<div class="col-lg-3  text-lg-right">
													<label for="required2" class="col-form-label">Name Of Account<span style="color: red;">*</span></label>
												</div>
												<div class="col-lg-4">
											...
											<div class="form-group row">
												<div class="col-lg-3  text-lg-right" style="margin-top: -7px;">
													<label for="required2" class="col-form-label">Account Type<span style="color: red;">*</span></label>
												</div>
                                                ...
                                                <label class="custom-control custom-radio">
                                                        <input name="radio3" type="radio" class="custom-control-input" onclick="selectAccountType(this.value)" id="selectDebit" value="2">
                                                        <span class="custom-control-indicator"></span>
				...
				<div class="outer">
					<div class="inner bg-container">
						<div class="card">
							<div class="card-header bg-white">CashBook Ledger Details</div>
										...
										<table	class="table  table-striped table-bordered table-hover dataTable no-footer"	id="editable_table" role="grid">
											<thead>
												<tr role="row">
													...
													<th class="sorting wid-25" tabindex="0" rowspan="1"	colspan="1">CashBook</th>
													<th class="sorting wid-25" tabindex="0" rowspan="1"	colspan="1">Name Of Account</th>
													<th class="sorting wid-25" tabindex="0" rowspan="1"	colspan="1">Account Type</th>
													<th class="sorting wid-10" tabindex="0" rowspan="1"	colspan="1">Action</th>
												</tr>
											</thead>	
											<%
												int count=1;
												List<CashBookLedgAccPOJO> list2=dao.selectLedgerAccount();
												Iterator<CashBookLedgAccPOJO> itr1=list2.iterator();
											...
											while(itr1.hasNext())
											{
												CashBookLedgAccPOJO pojo=(CashBookLedgAccPOJO)itr1.next();
												int id=((CashBookLedgAccPOJO)pojo).getId();
												String cashbook=((CashBookLedgAccPOJO)pojo).getCashBookName();
												String accname=((CashBookLedgAccPOJO)pojo).getAccountName();
											...
											%>
												...
												<tr class="gradeX">
													...
													<td><%=accname%></td>
													<%
													String type=((CashBookLedgAccPOJO)pojo).getAccountType();
													if(type.equals("0"))
													{
													%>
													<td>Both</td>
													...
													%>
													<td><a class="edit" data-toggle="modal"	data-placement="top" title="Update" href="#update"	onclick="searchSchool()"><i	class="fa fa-pencil text-warning"></i></a>&nbsp; &nbsp; 
...
function selectAccountType(x)
{

	alert(x);
	document.getElementById("accountType").value=x;

		...
		<div class="wrapper">
			...
			<div id="content" class="bg-container">
					...
					<div class="row no-gutters">
						<div class="col-sm-5 col-lg-6">
							<h4 class="nav_top_align">
								<i class="fa fa-pencil"></i> Account/SubAccount
							</h4>
						</div>
						<div class="col-sm-7 col-lg-6">
							<ol class="breadcrumb float-right nav_breadcrumb_top_align">
								...
								<li class="active breadcrumb-item">Account/SubAccount </li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-file-text-o"></i>Account/SubAccount
									</div>
									<div class="card-block m-t-35">
										<form action="/SMGMT/SubAccount" method="post"	class="form-horizontal  login_validator" id="form_block_validator">
											...
											<div class="form-group row">
	                                           ...
	                                           List<SubAccountPOJO> list=dao.selectCashcBook();
	                                           Iterator<SubAccountPOJO> itr=list.iterator();
	                                           %>
	                                              <select class="form-control chzn-select" tabindex="2" name="selectCashBook" id="required2" required>
	                                            	 <option disabled selected>select CashBook</option>
	                                              	...
	                                              	while(itr.hasNext())
	                                              	{
	                                              		SubAccountPOJO pojo=(SubAccountPOJO)itr.next();
	                                              		int id=((SubAccountPOJO)pojo).getId();
	                                              		String cashBook=((SubAccountPOJO)pojo).getCashBook();
                                         	...
                                         	<div class="form-group row">
	                                            <div class="col-lg-3 text-lg-right">
	                                               <label for="required2" class="col-form-label">Select Ledger<span style="color:red;">*</span></label>
	                                           </div>
	                                           
	                                           <div class="col-lg-4">
	                                           <%
	                                           List<SubAccountPOJO> list1=dao.selectLedger();
	                                           Iterator<SubAccountPOJO> itr1=list1.iterator();
	                                           %>
	                                              <select class="form-control chzn-select" tabindex="2" name="selectLedger" id="required2" required>
	                                            	 <option disabled selected>select ledger</option>
	                                              	<%
	                                              	while(itr1.hasNext())
	                                              	{
	                                              		SubAccountPOJO pojo=(SubAccountPOJO)itr1.next();
	                                              		int id=((SubAccountPOJO)pojo).getId();
	                                              		String ledgerName=((SubAccountPOJO)pojo).getLedgerName();
	                                              	
	                                              	%>
	                                                 <option value="<%=id%>"><%=ledgerName %></option>
	                                                 <%
	                                              	}
	                                                 %>
	                                              </select>
											...
											<div class="form-group row">
												<div class="col-lg-3  text-lg-right">
													<label for="required2" class="col-form-label">Account/SubAccount Name<span style="color: red;">*</span></label>
												</div>
												<div class="col-lg-4">
													<input type="text" id="required2" name="getAccountSubAccName" pattern="[A-Za-z]" onkeyup="this.value = this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>										
											
											<div class="form-actions form-group row">
												<div class="col-lg-4 push-lg-4">
													<button type="submit" name="AccountSubAccBTN" class="btn btn-success" >Submit</button>
				...
				<div class="outer">
					<div class="inner bg-container">
						<div class="card">
							<div class="card-header bg-white">Account/SubAccount Details</div>
										...
										<table	class="table  table-striped table-bordered table-hover dataTable no-footer"	id="editable_table" role="grid">
											<thead>
												<tr role="row">
													...
													<th class="sorting wid-25" tabindex="0" rowspan="1"	colspan="1">Name Of Ledger</th>
													<th class="sorting wid-25" tabindex="0" rowspan="1"	colspan="1">Account/SubAcc Name</th>
													<th class="sorting wid-10" tabindex="0" rowspan="1"	colspan="1">Action</th>
												</tr>
											</thead>	
													<%
													int count=1;
													List<SubAccountPOJO> list2=dao.fetchSubAccount();
													Iterator<SubAccountPOJO> itr2=list2.iterator();
											...
											while(itr2.hasNext())
											{
												SubAccountPOJO pojo=(SubAccountPOJO)itr2.next();
												int id=((SubAccountPOJO)pojo).getId();
												String cashBook=((SubAccountPOJO)pojo).getCashBook();
												String ledger=((SubAccountPOJO)pojo).getLedgerName();
												String subAccount=((SubAccountPOJO)pojo).getSubAccountName();

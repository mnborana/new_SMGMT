		...
		<div class="wrapper">
			...
			<div id="content" class="bg-container">
					...
					<div class="row no-gutters">
						<div class="col-sm-5 col-lg-6">
							<h4 class="nav_top_align">
								<i class="fa fa-pencil"></i> Add CashBook Name
							</h4>
						</div>
						<div class="col-sm-7 col-lg-6">
							<ol class="breadcrumb float-right nav_breadcrumb_top_align">
								...
								<li class="active breadcrumb-item">Add CashBook Name </li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-file-text-o"></i> Add CashBook Name
									</div>
									<div class="card-block m-t-35">
										<form action="/SMGMT/AddCashBook" method="post"	class="form-horizontal  login_validator" id="form_block_validator">


											<div class="form-group row">
												<div class="col-lg-3  text-lg-right">
													<label for="required2" class="col-form-label">Name Of CashBook<span style="color: red;">*</span></label>
												</div>
												<div class="col-lg-4">
													<input type="text" id="required2" name="getCashBookName" pattern="[A-Za-z]" onkeyup="this.value = this.value.toUpperCase()" class="form-control" required>
												</div>
											</div>
											...
											<div class="form-actions form-group row">
												<div class="col-lg-4 push-lg-4">
													...
													<button type="submit" name="AddCashBookBTN" class="btn btn-success" >Submit</button>
				...
				<div class="outer">
					<div class="inner bg-container">
						<div class="card">
							<div class="card-header bg-white">CashBook Details</div>
										...
										<table	class="table  table-striped table-bordered table-hover dataTable no-footer"	id="editable_table" role="grid">
											<thead>
												<tr role="row">
													...
													<th class="sorting wid-25" tabindex="0" rowspan="1"	colspan="1">Name Of CashBook</th>
											...
											List list=dao.fetchCashBookDetails();
											...
											while(itr.hasNext())
											{
												AddCashBookPOJO pojo=(AddCashBookPOJO)itr.next();
												int id=((AddCashBookPOJO)pojo).getId();
												String cashBookName=((AddCashBookPOJO)pojo).getCashBookName();

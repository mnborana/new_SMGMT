					...
					<div class="row no-gutters">
						<div class="col-sm-5 col-lg-6">
							<h4 class="nav_top_align">
								<i class="fa fa-pencil"></i> Gender Wise Report
							</h4>
						</div>
						<div class="col-sm-7 col-lg-6">
							<ol class="breadcrumb float-right nav_breadcrumb_top_align">
								...
								<li class="active breadcrumb-item">Gender Wise Report</li>
							</ol>
						</div>
					</div>
				</div>
								...
								<div class="card">
									...
									<div class="card-block m-t-35">
										<form action="/SMGMT/#" method="post"
											...
											<div class="form-group row">
												<div class="col-lg-3 text-lg-right">
													<label for="required2" class="col-form-label">Select Gender<span style="color: red;">*</span>
													</label>
												</div>
												<div class="col-lg-3 text-lg-right">
													<label class="custom-control custom-radio"> 
														<input name="gender" id="gender" type="radio" class="custom-control-input" value="Male" onclick="getGender(this.value)" checked > 
														<span class="custom-control-indicator"></span> 
														<span class="custom-control-description">Male</span>
													</label>
													
													<label class="custom-control custom-radio"> 
														<input name="gender" id="gender" type="radio" class="custom-control-input" value="Female" onclick="getGender(this.value)" > 
														<span class="custom-control-indicator"></span> 
														<span class="custom-control-description">Female</span>
													</label>
													
													<label class="custom-control custom-radio"> 
														<input name="gender" id="gender" type="radio" class="custom-control-input" value="All" onclick="getGender(this.value)" > 
														<span class="custom-control-indicator"></span> 

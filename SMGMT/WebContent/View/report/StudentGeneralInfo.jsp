<%@page import="com.servletStore.report.StudGeneralInfo.model.StudGeneralInfoPOJO"%>
<%@page import="com.servletStore.report.StudGeneralInfo.model.StudGeneralInfoIMPL"%>
<%@page import="com.servletStore.report.StudGeneralInfo.model.StudGeneralInfoDAO"%>
					...
					<div class="row no-gutters">
						<div class="col-sm-5 col-lg-6">
							<h4 class="nav_top_align">
								<i class="fa fa-pencil"></i> Student General Info
							</h4>
						</div>
						<div class="col-sm-7 col-lg-6">
							<ol class="breadcrumb float-right nav_breadcrumb_top_align">
								...
								<li class="active breadcrumb-item">Student General Info</li>
							</ol>
						</div>
					</div>
				</div>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-header bg-white">
										<i class="fa fa-file-text-o"></i> Student General Info
									</div>
									<div class="card-block m-t-35">
										<form action="/SMGMT/StudGeneralInfo" method="post"	class="form-horizontal  login_validator" id="form_block_validator">
											<div class="form-group row">
												<div class="col-lg-3 text-lg-right">
													<label for="required2" class="col-form-label">Select Standard<span style="color: red;">*</span>
													</label>
												</div>
												<%
												StudGeneralInfoDAO dao=new StudGeneralInfoIMPL();
												List<StudGeneralInfoPOJO> list=dao.selectStandard(schoolId);
												Iterator<StudGeneralInfoPOJO> itr=list.iterator();
												%>
												...
												<div class="col-lg-4">													
													<select class="form-control chzn-select" tabindex="2" name="selectstdDiv" id="required2" required>
														...
														while(itr.hasNext())
														{
															StudGeneralInfoPOJO pojo=(StudGeneralInfoPOJO)itr.next();
															int id=((StudGeneralInfoPOJO)pojo).getId();
															String standard=((StudGeneralInfoPOJO)pojo).getStandard();

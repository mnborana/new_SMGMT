...
$(document)
		.ready(
				function() {
					...
					$('.examples .custom-width-padding-background')
							.on(
									'click',
									function() {
										swal(
					...
					$('.examples .jqueryhtml').on(
							'click',
							function() {
								swal({
									title : 'jQuery HTML example',
									confirmButtonColor : '#4fb7fe',
									html : $('<div>').addClass('some-class')
